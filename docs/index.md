---
page_title: "config-v1alpha1 Provider"
---

# config-v1alpha1 Provider

This provider is used to interact with the resources provided by the **config-v1alpha1** application of the [Nokia EDA](https://docs.eda.dev) platform.
